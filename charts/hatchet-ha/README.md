...
Inherited by all backend services (`api`, `grpc`, `controllers`, `scheduler`).
...
| `grpc.enabled` | bool | `true` | Enable the gRPC engine component. |
| `grpc.replicaCount` | int | `1` | gRPC replicas. |
| `grpc.image.repository` | string | `"ghcr.io/hatchet-dev/hatchet/hatchet-engine"` | Engine image repository. |
| `controllers.enabled` | bool | `true` | Enable the controllers engine component. |
| `controllers.replicaCount` | int | `1` | Controllers replicas. |
| `scheduler.enabled` | bool | `true` | Enable the scheduler engine component. |
