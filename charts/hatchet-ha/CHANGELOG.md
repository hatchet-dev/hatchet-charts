...
- Update the default Hatchet image to [`v0.106.5`](https://github.com/hatchet-dev/hatchet/releases/tag/v0.106.5).
- Bump the bundled `hatchet-api` and `hatchet-frontend` subcharts to `0.18.0`.

## [0.17.0] - 2026-08-31

- Update the default Hatchet image to [`v0.105.16`](https://github.com/hatchet-dev/hatchet/releases/tag/v0.105.16).
- Bump the bundled `hatchet-api` and `hatchet-frontend` subcharts to `0.17.0`.

## [0.16.0] - 2026-08-25

- Update the default Hatchet image to [`v0.105.2`](https://github.com/hatchet-dev/hatchet/releases/tag/v0.105.2).
- Bump the bundled `hatchet-api` and `hatchet-frontend` subcharts to `0.16.0`.

## [0.15.0] - 2026-08-17

- Update the default Hatchet image to [`v0.101.27`](https://github.com/hatchet-dev/hatchet/releases/tag/v0.101.27).
- Bump the bundled `hatchet-api` and `hatchet-frontend` subcharts to `0.15.0`.
...
[Unreleased]: https://github.com/hatchet-dev/hatchet-charts/compare/hatchet-ha-0.18.0...HEAD
[0.18.0]: https://github.com/hatchet-dev/hatchet-charts/releases/tag/hatchet-ha-0.18.0
[0.17.0]: https://github.com/hatchet-dev/hatchet-charts/releases/tag/hatchet-ha-0.17.0
[0.16.0]: https://github.com/hatchet-dev/hatchet-charts/releases/tag/hatchet-ha-0.16.0
[0.15.0]: https://github.com/hatchet-dev/hatchet-charts/releases/tag/hatchet-ha-0.15.0
[0.14.0]: https://github.com/hatchet-dev/hatchet-charts/releases/tag/hatchet-ha-0.14.0
